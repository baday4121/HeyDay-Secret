    ...
    <div class="w-full max-w-lg">
        ...
        <div class="space-y-4">
            @forelse($messages as $msg)
                <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-200 overflow-hidden relative">
                    
                    @if(isset($msg->replies_count) && $msg->replies_count > 0)
                        <div class="absolute top-4 right-4 bg-blue-50 text-blue-600 border border-blue-200 text-xs font-normal px-2.5 py-0.5 rounded-full flex items-center gap-1 shadow-xs">
                    ...
                    <p class="text-gray-700 text-sm font-normal mb-3 break-words whitespace-pre-line pr-12">{{ Str::limit($msg->content, 510) }}</p>
